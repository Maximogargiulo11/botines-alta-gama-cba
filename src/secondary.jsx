      ...
      <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', minHeight: isMobile ? 'auto' : '100vh' }}>
        ...
        <div style={{ position: 'relative', overflow: 'hidden', minHeight: isMobile ? 280 : 600 }}>
          ...
          <div style={{
            ...
            background: isMobile
              ? 'linear-gradient(180deg, transparent 50%, rgba(42,24,16,0.7))'
              : 'linear-gradient(90deg, transparent 70%, rgba(42,24,16,0.4))'
          }} />
          {!isMobile && (
            <div style={{
        ...
        <div style={{
          padding: isMobile ? '48px 20px 60px' : '100px 80px',
          ...
          <h2 style={{
            fontFamily: 'var(--display)',
            fontSize: isMobile ? 'clamp(52px, 16vw, 80px)' : 'clamp(56px, 7vw, 104px)',
            lineHeight: 0.95,
          ...
          <div style={{
            ...
            gap: isMobile ? 8 : 12, marginBottom: isMobile ? 28 : 40
          }}>
            {[
          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'center', flexWrap: 'wrap', marginBottom: 32 }}>
            ...
            >
              Ver Hora Dorada <Icon name="arrow_right" size={14} />
            </button>
          </div>
