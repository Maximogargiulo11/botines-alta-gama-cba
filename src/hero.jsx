  ...
  return (
    <section data-screen-label="01 Hero Tunit" style={{
      ...
      <div style={{ position: 'absolute', inset: 0 }}>
        ...
        {isMobile ? (
          <div style={{
            ...
            background: 'linear-gradient(180deg, rgba(5,13,24,0.4) 0%, rgba(5,13,24,0.7) 50%, rgba(5,13,24,0.97) 80%)'
          }} />
        ) : (
          <>
            <div style={{
      ...
      <div className="container" style={{
        ...
        padding: isMobile ? '80px 20px 60px' : '80px 32px',
        gap: 40
      }}>
        {/* Bloque con copy */}
        <div className="fade-up" style={{ maxWidth: isMobile ? '100%' : 580 }}>
          ...
          <h1 style={{
            ...
            fontWeight: 400,
            fontSize: isMobile ? 'clamp(56px, 18vw, 96px)' : 'clamp(56px, 8vw, 124px)',
            lineHeight: 0.92,
          ...
          <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', marginBottom: isMobile ? 28 : 48 }}>
      ...
      <div style={{
        ...
        display: isMobile ? 'none' : 'flex', flexDirection: 'column', alignItems: 'center', gap: 10,
